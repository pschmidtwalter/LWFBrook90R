...
#'   \code{options.b90}-argument in \code{\link{runLWFB90}}.
#'
#' @details
#' \describe{
...
#'   \item{prec.interval}{number of precipitation intervals per day (default is
#'   1). If \code{prec.interval > 1}, the \code{precip}-argument has to be
#'   provided to \code{\link{runLWFB90}}}
#'   \item{prec.corr}{correct precipitation data for wind and evaporation losses
#'   using \code{\link{prec_corr}}?} \item{budburst.method}{name of method for
...
#'   \item{standprop.input}{name of input for longterm (interannual) plant
#'   development. \code{standprop.input = 'parameters'}: yearly values of stand
#'   properties height, sai, densef, lai are taken from individual parameters,
#'   \code{standprop.input = 'table'}:  values from \code{standprop.table}
#'   provided in parameters are used.} \item{standprop.interp}{interpolation
#'   method for aboveground stand properties. \code{'linear'} or
#'   \code{'constant'}, see \code{approx.method}-argument of
#'   \code{\link{approx_standprop}}.} \item{standprop.use_growthperiod}{Should
...
#'   budburstdoy and leaffalldoy. See 'use_growthperiod'-argument of
#'   \code{\link{approx_standprop}}.} \item{lai.method}{name of method for
...
#'   Clapp/Hornberger, "MvG" for Mualem/van Genuchten} \item{root.method}{method
