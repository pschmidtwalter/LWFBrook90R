...
param_b90$lai.doy <- c(1,110,117,135,175,220,250,290,365)
param_b90$lai.frac <- c(0.1,0.1,0.5,0.7,1.2,1.2,1.0,0.1,0.1)
...
param_b90$shape.budburst <- 0.5
param_b90$shape.leaffall <- 5
param_b90$shape.optdoy <- 180
...
with(param_b90, arrows(x0 = c(budburstdoy,leaffalldoy,shape.optdoy,budburstdoy,leaffalldoy),
...
with(param_b90, text(x = c(budburstdoy, leaffalldoy, shape.optdoy), y = c(-1.9,-1.9,3.2), c("budburstdoy", "leaffalldoy", "shape.optdoy")))
...
param_b90$shape.optdoy <- c(210,180,240)
param_b90$shape.budburst <- c(3,1,0.3)
...
legend("topleft", legend = c("approx.method = 'constant'", "approx.method = 'linear'", "approx.method = 'linear', use_growthperiod = TRUE"), 
       ...
       bty = "n")
arrows( x0 = as.Date(paste(param_b90$budburstdoy, years),format = "%j %Y"),
     y0 = c(param_b90$height.in,param_b90$height[1:2])-0.5, y1 = c(param_b90$height.in,param_b90$height[1:2])-0.1, length = 0.15, code = 2, xpd =T)
text(x = as.Date(paste(param_b90$budburstdoy, years), format = "%j %Y"),
     y = c(param_b90$height.in,param_b90$height[1:2])-0.7, paste("doy", param_b90$budburstdoy), xpd = T)
