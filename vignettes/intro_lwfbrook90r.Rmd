...
Before installing the *LWFBrook90r* R-package, be sure to download and install the 'Rbrook90' and 'data.table' packages, as *LWFBrook90r* depends on them:

```{r, eval = F}
install.packages("Rbrook90", repos="https://cran.rstudio.com/")
