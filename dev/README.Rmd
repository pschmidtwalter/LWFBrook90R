...
Before installing the package, the following imported packages need to be installed from CRAN:
```{r}
...
- [ ] implement unit tests (currently functionality is tested mostly through vignette building)
