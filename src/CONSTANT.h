!   2019.02. Adjusted and cleaned by V.Trotsiuk[volodymyr.trotsiuk@usys.ethz.ch] to be used in R package
...
!     CVSOL - volumetric heat capacity of solid, MJ m-2 mm-1 K-1  (hillel98)
!     CVSOL = .0020d0
! !     CVORG - volumetric heat capacity of organic material, MJ m-2 mm-1 K-1 (hillel98)
!     CVORG = .00250d0
! !     Longitudinal thermal dispersivity [m] set to zero
!     ThDis = 0.0d0
