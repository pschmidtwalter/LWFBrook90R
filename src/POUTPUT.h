...
IF (OP(3, 4) .EQ. 1) THEN
    IF (IDAY .EQ. 1 .AND. N .EQ. 1) THEN
        OPEN (UNIT = 22, FILE = 'FLOWPRE.ASC', STATUS='REPLACE')
...
IF (OP(4, 4) .EQ. 1) THEN
    IF (IDAY .EQ. 1 .AND. N .EQ. 1) THEN
        OPEN (UNIT = 23, FILE = 'EVAPPRE.ASC', STATUS='REPLACE')
...
IF (OP(5, 4) .EQ. 1) THEN
    IF (IDAY .EQ. 1 .AND. N .EQ. 1) THEN
        OPEN (UNIT = 24, FILE = 'ABOVPRE.ASC', STATUS='REPLACE')
...
IF (OP(6, 4) .EQ. 1) THEN
    IF (IDAY .EQ. 1 .AND. N .EQ. 1) THEN
        OPEN (UNIT = 26, FILE = 'BELOPRE.ASC', STATUS='REPLACE')
...
IF (OP(8, 4) .EQ. 1) THEN
    IF (IDAY .EQ. 1 .AND. N .EQ. 1) THEN
        OPEN (UNIT = 27, FILE = 'PSITPRE.ASC', STATUS='REPLACE')
