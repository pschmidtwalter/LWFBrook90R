...
IF (OP(3, 4) .EQ. 1) THEN
    IF (IDAY .EQ. 1 .AND. N .EQ. 1) THEN
        OPEN (UNIT = 22, FILE = 'out/FLOW.PRE', STATUS='REPLACE')
...
IF (OP(4, 4) .EQ. 1) THEN
    IF (IDAY .EQ. 1 .AND. N .EQ. 1) THEN
        OPEN (UNIT = 23, FILE = 'out/EVAP.PRE', STATUS='REPLACE')
...
IF (OP(5, 4) .EQ. 1) THEN
    IF (IDAY .EQ. 1 .AND. N .EQ. 1) THEN
        OPEN (UNIT = 24, FILE = 'out/ABOV.PRE', STATUS='REPLACE')
...
IF (OP(6, 4) .EQ. 1) THEN
    IF (IDAY .EQ. 1 .AND. N .EQ. 1) THEN
        OPEN (UNIT = 26, FILE = 'out/BELO.PRE', STATUS='REPLACE')
...
IF (OP(8, 4) .EQ. 1) THEN
    IF (IDAY .EQ. 1 .AND. N .EQ. 1) THEN
        OPEN (UNIT = 27, FILE = 'out/PSIT.PRE', STATUS='REPLACE')
