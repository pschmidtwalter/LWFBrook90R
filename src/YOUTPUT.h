...
IF (OP(2,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 51, FILE = 'BUDGANN.csv', STATUS='REPLACE')
...
IF (OP(3,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 52, FILE = 'FLOWANN.csv', STATUS='REPLACE')
...
IF (OP(1,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 59, FILE = 'EVALANN.csv', STATUS='REPLACE')
...
IF (OP(4,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 53, FILE = 'EVAPANN.csv', STATUS='REPLACE')
...
IF (OP(4,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 60, FILE = 'EPVPANN.csv', STATUS='REPLACE')
...
IF (OP(5,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 54, FILE = 'ABOVANN.csv', STATUS='REPLACE')
...
!        stress factor - ratio of actual to potential transpiration
    ...
    END IF
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 55, FILE = 'MISCANN.csv', STATUS='REPLACE')
...
IF (OP(6,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 56, FILE = 'BELOANN.csv', STATUS='REPLACE')
...
IF (OP(8,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 57, FILE = 'PSITANN.csv', STATUS='REPLACE')
...
IF (OP(7,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 58, FILE = 'SWATANN.csv', STATUS='REPLACE')
