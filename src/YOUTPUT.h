...
IF (OP(2,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 51, FILE = 'out/BUDGANN.csv', STATUS='REPLACE')
...
IF (OP(3,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 52, FILE = 'out/FLOWANN.csv', STATUS='REPLACE')
...
IF (OP(1,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 59, FILE = 'out/EVALANN.csv', STATUS='REPLACE')
...
IF (OP(4,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 53, FILE = 'out/EVAPANN.csv', STATUS='REPLACE')
...
IF (OP(4,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 60, FILE = 'out/EPVPANN.csv', STATUS='REPLACE')
...
IF (OP(5,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 54, FILE = 'out/ABOVANN.csv', STATUS='REPLACE')
...
!        stress factor - ratio of actual to potential transpiration
    ...
    END IF
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 55, FILE = 'out/MISCANN.csv', STATUS='REPLACE')
...
IF (OP(6,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 56, FILE = 'out/BELOANN.csv', STATUS='REPLACE')
...
IF (OP(8,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 57, FILE = 'out/PSITANN.csv', STATUS='REPLACE')
...
IF (OP(7,1) .EQ. 1) THEN
    IF (IDAY .LT. 367) THEN
        OPEN (UNIT = 58, FILE = 'out/SWATANN.csv', STATUS='REPLACE')
