...
IF (OP(2,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 41, FILE = 'BUDGMON.ASC', STATUS='REPLACE')
...
IF (OP(3,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 42, FILE = 'FLOWMON.ASC', STATUS='REPLACE')
...
IF (OP(1,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 49, FILE = 'EVALMON.ASC', STATUS='REPLACE')
...
IF (OP(4,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 43, FILE = 'EVAPMON.ASC', STATUS='REPLACE')
...
IF (OP(5,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 44, FILE = 'ABOVMON.ASC', STATUS='REPLACE')
...
!        output
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 45, FILE = 'MISCMON.ASC', STATUS='REPLACE')
...
IF (OP(6,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 46, FILE = 'BELOMON.ASC', STATUS='REPLACE')
...
IF (OP(8,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 47, FILE = 'PSITMON.ASC', STATUS='REPLACE')
...
IF (OP(7,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 48, FILE = 'SWATMON.ASC', STATUS='REPLACE')
