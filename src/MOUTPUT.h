...
IF (OP(2,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 41, FILE = 'BUDGMON.csv', STATUS='REPLACE')
...
IF (OP(3,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 42, FILE = 'FLOWMON.csv', STATUS='REPLACE')
...
IF (OP(1,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 49, FILE = 'EVALMON.csv', STATUS='REPLACE')
...
IF (OP(4,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 43, FILE = 'EVAPMON.csv', STATUS='REPLACE')
...
IF (OP(5,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 44, FILE = 'ABOVMON.csv', STATUS='REPLACE')
...
!        output
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 45, FILE = 'MISCMON.csv', STATUS='REPLACE')
...
IF (OP(6,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 46, FILE = 'BELOMON.csv', STATUS='REPLACE')
...
IF (OP(8,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 47, FILE = 'PSITMON.csv', STATUS='REPLACE')
...
IF (OP(7,2) .EQ. 1) THEN
    IF (IDAY .LT. 32) THEN
        OPEN (UNIT = 48, FILE = 'SWATMON.csv', STATUS='REPLACE')
